...
public class FishFragment extends BaseFragment implements
        FishView, FishAdapter.Callback, FishAdapter.onItemListener {

    public static final String TAG = FishFragment.class.getSimpleName();

    @Inject
    FishMvpPresenter<FishView> mPresenter;

    @Inject
    FishAdapter mFishAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        if (component != null) {
            ...
            mFishAdapter.setCallback(this);
            mFishAdapter.setOnListener(this);
        }
        return view;
    }
    ...
    protected void setUp(View view) {
        ...
        mRecyclerView.setAdapter(mFishAdapter);
    ...
    public void updateData(List<FoodResponse.Food> blogList) {
        mFishAdapter.addItems(blogList);
    }
