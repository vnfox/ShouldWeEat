...
public class FruitsFragment extends BaseFragment implements
        FruitsView, FruitsAdapter.Callback, FruitsAdapter.onItemListener {

    public static final String TAG = FruitsFragment.class.getSimpleName();

    @Inject
    FruitsMvpPresenter<FruitsView> mPresenter;

    @Inject
    FruitsAdapter mFruitAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        if (component != null) {
            ...
            mFruitAdapter.setCallback(this);
            mFruitAdapter.setOnListener(this);
        }
        return view;
    }
    ...
    public void updateData(List<FoodResponse.Food> blogList) {
        mFruitAdapter.addItems(blogList);
    }
