...
public class VegetablesFragment extends BaseFragment implements
        VegetablesView, VegetablesAdapter.Callback, VegetablesAdapter.onItemListener {

    public static final String TAG = VegetablesFragment.class.getSimpleName();

    @Inject
    VegetablesMvpPresenter<VegetablesView> mPresenter;

    @Inject
    VegetablesAdapter mVegetablesAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        if (component != null) {
            ...
            mVegetablesAdapter.setCallback(this);
            mVegetablesAdapter.setOnListener(this);
        }
        return view;
    }
    ...
    protected void setUp(View view) {
        ...
        mRecyclerView.setAdapter(mVegetablesAdapter);
    ...
    public void updateData(List<FoodResponse.Food> blogList) {
        mVegetablesAdapter.addItems(blogList);
    }
